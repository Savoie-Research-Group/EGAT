...
# pylint: enable=W0235
class EGATConvResidSA(nn.Module):
    r"""
    ...
    def node_attention(self, nodes):
        ...
        return {'a_node': a_node, 'h' : nfeats_,'h_resid':h_resid}
    ...
    def forward(self, graph, nfeats, efeats):
        ...
        ##TODO allow node src and dst feats
            ...
            if self._out_node_feats != self._in_node_feats:
                if self._edge_resid_setting == 'v1' or self._edge_resid_setting == 'v2':
                    graph.ndata['h'] += graph.ndata['h_resid']
                    ...
                    graph.ndata['h'] = self.node_gate_connector(graph.ndata['h'],graph.ndata['h_resid'])
